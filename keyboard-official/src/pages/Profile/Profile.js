    ...
    return (
        <div className="root">
            <Typography>
                ...
                <Title>介绍</Title>
                <Paragraph>
                大家好，我是小恐龙，也是一名机械键盘爱好者。之前在键盘群里和大家聊天发现目前还没有什么工具可以直观的显示当前键盘团购的进度，所以想了一下决定自己写一个，这样大家能一起用，也算为我们的键盘社区贡献一点自己的力量。这个网站的每一条数据都是我一个个找的，为了尽可能的保证数据准确性，我会找到对应的官方团购贴进行核对，但即使这样，<Text mark>由于我个人所能投入的精力有限，难免会出现数据不准确的情况，请大家谅解。如果大家发现数据不准确的情况请随时给我<a href={`mailto:${customerEmail}?subject=数据纠正`} >发邮件</a>，我会尽快更新</Text>。同时如果大家对网站有什么建议也欢迎大家<a href={`mailto:${customerEmail}?subject=键盘网站建议`} >发邮件</a>给我，我会酌情采纳。后续我也会开发更多的功能，希望这个网站能成为我们玩家群体共同的客制化网站！
                </Paragraph>
                <Paragraph>
