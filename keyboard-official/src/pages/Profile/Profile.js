    ...
    return (
        <div className="root">
            <Typography>
                ...
                <Title>介绍</Title>
                <Paragraph>
                大家好，我是小恐龙，也是一名机械键盘爱好者。我写这个网站的原因是之前在键盘群里和大家聊天发现目前还没有什么工具可以直观的显示当前键盘团购的进度，所以想了一下决定自己写一个，这样大家也能一起用，也算为我们的键盘社区贡献一点自己的力量。这个网站的每一条数据都是我一个个找的，为了尽可能的保证数据准确性，我会找到对应的官方团购贴进行核对，但即使这样，<Text mark>由于我个人所能投入的精力有限，难免会出现数据不准确的情况，请大家谅解。如果大家发现数据不准确的情况请随时给我<a href={`mailto:${customerEmail}?subject=数据纠正`} >发邮件</a>，我会尽快的修正错误</Text>。同时如果大家对网站有什么建议也欢迎大家<a href={`mailto:${customerEmail}?subject=键盘网站建议`} >发邮件</a>给我，我会尽量改进。后续我也会开发更多的功能，我希望这个网站能成为我们玩家群体共同的客制化网站，我会尽可能采纳大家的意见！
                </Paragraph>
                <Paragraph>
                ...
                <Paragraph>
                在买这个网站的域名mykeyboard.fun时，我并不知道有mykeyboard.eu这个网站，俗话说买的早不如买的巧，一不小心这个域名我还买了10年...由于域名和云服务的费用我均为自费，所以暂时就不更换了，如果mykeyboard.eu的所有者有所介意的话可以发邮件联系我，到时我会对域名进行更换，谢谢理解。
                </Paragraph>
