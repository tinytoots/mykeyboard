    ...
    return (
        <div className="root">
            <Typography>
                ...
                <Paragraph>
                Hello everyone, my name is Chen. and I am a mechanical keyboard enthusiast. I found that there is no convenient tool to visually display the progress of the keyboard group-buying, so I decided to build one myself so that we can all use it together. I hope to contribute a little to our keyboard community. Every piece of data on this site is searched and added by me one by one. In order to ensure the accuracy of the data as much as possible, I will find the corresponding official group-buying post to check. But even so, <Text mark>due to the limited time and energy I can personally devote, inevitably there will be inaccurate data, please understanding.  If you find any of the above problems, please feel free to <a href={`mailto:${customerEmail}?subject=Data correction`} >send me an email</a> and I will update it as soon as possible</Text>. Also, if you have any suggestions or interesting features for this website, please feel free to <a href={`mailto:${customerEmail}?subject=Keyboard website suggestions`} >contact me by email</a>. I will develop it step by step according to your needs if these features can help more people, and I hope this website will become our customized website!
                </Paragraph>   
                <Paragraph>
                If the keyboard or keycap you want to search is not displayed on the website, please <a href={`mailto:${customerEmail}?subject=Data add`} >send an email</a> to let me know, and I will add it as soon as possible. Please indicate the correct and complete name of the kit or keycap in the email. It would be better if you can attach the link or screenshot of the official group purchase sticker. This can help me greatly save the workload of confirming the information, thanks!
                </Paragraph>
                <Paragraph>
