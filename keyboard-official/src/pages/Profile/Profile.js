    ...
    return (
        <div className="root">
            <Typography>
                ...
                {/* <Divider /> */}
                <Text type="secondary">手机端打开网页时进度条会被压缩消失，推荐使用电脑或者iPad浏览</Text>
                <Title>介绍</Title>
                <Paragraph>
                ...
                <Paragraph>
                <Text mark>如果你想要查询的套件或者键帽在网站中没有显示，欢迎<a href={`mailto:${customerEmail}?subject=数据添加`} >发邮件</a>告知我，我会尽快添加</Text>。请在邮件中标明正确且完整的套件或键帽名称，如果能附带官方团购贴的链接或截图更好，这样可以帮助我大大节省确认信息的工作量，感谢！
                </Paragraph>
                <Paragraph>
